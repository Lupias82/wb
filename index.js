...
const configs = {
	...
	webhook_url: 'https://wa.quota.my.id/filewebhook/webhook.php',
	webhook_group: 'https://wa.quota.my.id/filewebhook/hookgroup.php',
	callback_url: 'https://wa.quota.my.id/callback.php' // webhook url
};
